    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button
            size="sm"
            onClick={() => router.push(`/dashboard/admin/customers/${orderData.customer.email.split("@")[0]}`)}
          >
            View Customer
          </Button>
        </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-sm">{orderData.provider.email}</p>
                </div>
                <div className="flex items-center gap-2">
                  <MapPin className="h-4 w-4 text-muted-foreground" />
                  <p className="text-sm">789 Laundry St, New York, NY 10003</p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <h4 className="font-medium">Pickup & Delivery Schedule</h4>
              ...
              <Button
                ...
                onClick={() =>
                  router.push(
                    `/dashboard/admin/providers/${orderData.provider.name.replace(/\s+/g, "-").toLowerCase()}`,
                  )
                }
              >
